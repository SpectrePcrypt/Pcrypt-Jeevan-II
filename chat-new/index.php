...
include('header.php');
?>
<title>Jeevan Live Consultation with Doctors</title>
...
<div class="container">
	<h1>Live Consultation with Doctors</h1>
	<br>
	...
	<div style="margin:50px 0px 0px 0px;">
		<a class="btn btn-default read-more" style="background:#3399ff;color:white" href="../homepage.html">Back to Home Page</a>
	</div>
</div>
